...
class RenderThreadImpl {
 public:
  scoped_refptr<blink::StreamTextureFactoryInterface> GetStreamTextureFactory();
#if defined(USE_NEVA_SUSPEND_MEDIA_CAPTURE)
 ...
 protected:
  void Init();
  scoped_refptr<blink::StreamTextureFactoryInterface> stream_texture_factory_;
#if defined(USE_NEVA_SUSPEND_MEDIA_CAPTURE)
...
template <typename original_t>
scoped_refptr<blink::StreamTextureFactoryInterface>
...
// TODO(sync-to-77-media): need to be fixed
  ...
  scoped_refptr<blink::StreamTextureFactoryInterface> stream_texture_factory =
