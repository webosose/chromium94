...
class StreamTextureProxy : public StreamTextureHost::Listener,
                           public blink::StreamTextureProxyInterface {
 public:
...
class StreamTextureFactory : public blink::StreamTextureFactoryInterface {
 public:
  ...
  blink::StreamTextureProxyInterface* CreateProxy() override;
